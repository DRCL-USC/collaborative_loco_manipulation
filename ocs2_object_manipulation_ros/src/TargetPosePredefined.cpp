...
int main(int argc, char *argv[])
{
  ...
  vector_t finalState_{STATE_DIM};
  loadData::loadEigenMatrix(taskFile, "finalState", finalState_);
  ...
  const TargetTrajectories targetTrajectories = commandLineToTargetTrajectories(finalState_, latestObservation_);
